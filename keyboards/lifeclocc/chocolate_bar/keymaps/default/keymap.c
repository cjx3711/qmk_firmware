...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    CTL_T(KC_LBRC), MO(_FN), KC_LALT, KC_LGUI, LT(_RAISE, ____) , LT(_LOWER, KC_ENT) , KC_SPC, \
    KC_BSPC, LT(_LOWER, G(KC_BSPC)), LT(_RAISE, G(KC_BSPC)), KC_RGUI, KC_RALT, MO(_FN), RCTL_T(KC_RBRC)
  ),
  ...
  [_LOWER] = LAYOUT(
    KC_GRV ,   ____ ,   ____ ,   ____ ,   ____ ,   ____ ,                 KC_PGUP ,   KC_HOME ,   KC_UP ,   KC_END ,   ____ ,   ____ , \
    KC_TILD ,   ____ ,   ____ ,   ____ ,   ____ ,   ____ ,                 KC_PGDN ,   KC_LEFT ,   KC_DOWN ,   KC_RIGHT ,   ____ ,   ____ ,  \
  ...
  [_FN] = LAYOUT(
    ...
    KC_MPLY ,   ____ ,   ____ ,   ____ ,   ____ ,   ____ , ____ ,   ____ , ____ ,   ____ ,   ____ ,   ____ ,   ____ ,   ____ 
  ),
  [_MOUSE] = LAYOUT(
    ...
    ____ ,   ____ ,   ____ ,   ____ ,   KC_ACL0 ,   KC_ACL1 , KC_ACL2 ,   KC_BTN1 , KC_BTN2 ,   KC_BTN3 ,   ____ ,   ____ ,   ____ ,   ____ 
  ),
};
